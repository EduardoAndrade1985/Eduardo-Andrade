...
_SUPABASE_PUBLIC_URL = os.environ.get('SUPABASE_S3_PUBLIC_URL', '')
...
STORAGES = {
    ...
    } if _SUPABASE_URL and _SUPABASE_KEY_ID else {
...
# Origens fixas: app Capacitor Android e desenvolvimento local
_CAPACITOR_ORIGINS = [
    'capacitor://localhost',
    'http://localhost',
    'https://localhost',
...
if FRONTEND_URL:
    CORS_ALLOWED_ORIGINS = [u.strip() for u in FRONTEND_URL.split(',')] + _CAPACITOR_ORIGINS
else:
    CORS_ALLOWED_ORIGINS = _CAPACITOR_ORIGINS
