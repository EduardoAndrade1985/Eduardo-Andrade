...
function Ic({ n, cls = 'w-4 h-4 flex-shrink-0' }) {
  const p = {
    ...
    enxoval:    <><rect x="2" y="4" width="20" height="5" rx="1"/><rect x="2" y="11" width="20" height="5" rx="1"/><rect x="2" y="18" width="13" height="4" rx="1"/></>,
...
const SECOES = [
  ...
  },
  {
    ...
    itens: [
      ...
      { label: 'Enxoval',      icon: 'enxoval', path: '/enxoval',      ativo: true,  key: 'enxoval'      },
    ],
  },
  {
    id: 'gerencial',
