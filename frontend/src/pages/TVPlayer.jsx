            ...
            {tabela.map((row, i) => {
              ...
              return (
                <div key={i}
                  ...
                  <span className="text-[13px] font-bold text-center" style={{ color: tc }}>{row.taxa.toFixed(1)}%</span>
                  <span className="text-[13px] text-white/70 text-center font-semibold">{row.uhs}</span>
            ...
            {[
              ...
              <div key={i} className="grid grid-cols-3 items-center py-2 border-b border-white/[0.04] last:border-0">
                ...
                <div className="text-right">
                  {k.var != null ? <Var v={k.var} unit={k.unit || '%'} /> : <span className="text-[11px] text-white/20">—</span>}
                </div>
              </div>
            ))}
          </div>
